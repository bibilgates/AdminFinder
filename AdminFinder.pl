...
print "\t\t+++++++++++++++++++++++++++++++++++++++++++++++++++++\n";  
print "\t\t====================================================\n";
print "\t\t\t AdminFinder v1.1\n";
print "\t\t\t IndoXploit - Mr.b0g3L\n ";
print "\t\t=====================================================\n";
print "\n\n";
# print "\t\t+++++++++++++++++++++++++++++++++++++++++++++++++++++\n";  
sleep (1);
    print "\n\n";
    print "\t HOST=> (ex: http://www.coli.com)\n";
    print "\t HOST=> :";
    $host=<STDIN>;
    chomp($host);
...
if ($response->is_success){print "Di Temukan : $url\n";}
if ($response->content=~ /Access Denied/){print "Di Temukan : $url =>[Error & Access Denied]\n";}
else {print "Tidak Di Temukan :V => $myadmin\n";}
